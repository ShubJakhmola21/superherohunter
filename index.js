...
inputName.addEventListener("keypress", function(event) {
  if (event.key === "Enter") {
    ...
    console.log("enter");
//    "http://gateway.marvel.com/v1/public/comics?ts=2113&apikey=ba5b1a76e7d5527bb839375d5544c8a9&hash=2ac3fa9f940130e136ebc196c75741d3"
    if (name !== '') {
        fetch('https://gateway.marvel.com:443/v1/public/characters?'+'ts=2113&apikey=ba5b1a76e7d5527bb839375d5544c8a9&hash=53dd148ec348851dc639a2b3066ac6f4')
